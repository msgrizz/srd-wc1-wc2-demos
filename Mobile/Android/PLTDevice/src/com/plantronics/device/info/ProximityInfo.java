 ...
 */
public class ProximityInfo extends com.plantronics.device.info.Info {
	...
	public ProximityInfo(int requestType, Date timestamp, com.plantronics.device.calibration.Calibration calibration, int pcProximity, int mobileProximity) {
