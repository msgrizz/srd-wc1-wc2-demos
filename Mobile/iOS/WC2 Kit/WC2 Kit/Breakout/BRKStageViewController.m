...
@interface BRKStageViewController () <PLTDeviceSubscriber> {
...
- (void)subscribeToServices
{
	...
	if (CONNECTED_DEVICE) {
		...
		[d subscribe:self toService:PLTServiceTaps withMode:PLTSubscriptionModePeriodic andPeriod:MIN_PERIODIC_SUBSCRIPTION_PERIOD error:&err];
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    self.tabBarItem.image = [UIImage imageNamed:@"game_tab_icon.png"];
