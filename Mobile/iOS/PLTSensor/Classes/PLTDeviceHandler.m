...
@interface PLTDeviceHandler () <UIAccelerometerDelegate, PLTDeviceSubscriber>
...
@implementation PLTDeviceHandler

#pragma mark - Public

+ (PLTDeviceHandler *)sharedHandler
{
    static PLTDeviceHandler *handler = nil;
    if (!handler) {
        handler = [[PLTDeviceHandler alloc] init];
