...
//
//  Manages connection to, parsing of data from, and calibration for an MFi headset via the ExternalAccessory framework.
//  Connection happens automatically and is maintained by this class at all times.
//
