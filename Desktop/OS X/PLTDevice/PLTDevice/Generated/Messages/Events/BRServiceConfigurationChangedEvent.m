//
//  BRServiceConfigurationChangedEvent.m
//  BRDevice
//
...
@interface BRServiceConfigurationChangedEvent ()
...
@implementation BRServiceConfigurationChangedEvent
...
- (uint16_t)deckardID
{
	return BR_SERVICE_CONFIGURATION_CHANGED_EVENT;
}
...
{
    return [NSString stringWithFormat:@"<BRServiceConfigurationChangedEvent %p> serviceID=0x%04X, characteristic=0x%04X, configurationData=%@",
