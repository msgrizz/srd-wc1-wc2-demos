...
@interface BRLastDateUsedSettingResult ()
...
@implementation BRLastDateUsedSettingResult
...
- (uint16_t)deckardID
{
	return BR_LAST_DATE_USED_SETTING_RESULT;
}
...
{
    return [NSString stringWithFormat:@"<BRLastDateUsedSettingResult %p> month=0x%04X, day=0x%04X, year=0x%08X",
