...
namespace Plantronics.Innovation.PLTLabsAPI
{
    ...
    /// </summary>
    public class PLTLabsAPI : HeadtrackingUpdateHandler
    {
        Spokes m_spokes;
        QuaternionProcessor m_quatproc;
        internal PLTLabsCallbackHandler m_callbackhandler;
        private bool m_isConnectedToSpokes = false;
        ...
        private Interop.Plantronics.ICOMDevice m_attacheddevice = null;
